...
#Region "5. Persistencia (Base de Datos - CRUD)"
    ...
    Private Sub GuardarPedido()
        ...
        Try
            ...
            If esNuevo Then
                sql = "INSERT INTO PedidosCompra (NumeroPedidoCompra, NumeroAlbaranProveedor, ID_Proveedor, Fecha, FechaEntregaPrevista, Observaciones, Estado, ID_FormaPago, ID_Comprador, BaseImponible, ImporteIVA, Total) " &
                      "VALUES (@num, @num, @prov, @fecha, @fechaEnt, @obs, @est, @formaPago, @comp, @base, @iva, @total); SELECT last_insert_rowid();"
            Else
