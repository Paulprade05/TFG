...
Public Class FrmAlbaranes
    ...
    Private Sub CargarDesplegables()
        _agenciaManualSinRutas = False ' Reseteamos la memoria al cargar o limpiar
        Try
    ...
    Private Sub ReorganizarControlesAutomaticamente()
        ...
        Dim lblObs As Label = Me.Controls.OfType(Of Label)().FirstOrDefault(Function(l) l.Name = "LblObservacionesAlb")
        If lblObs Is Nothing Then
            lblObs = New Label() With {.Name = "LblObservacionesAlb", .AutoSize = False, .Text = "Observaciones",
        ...
        ' Buscar el TextBoxObservaciones interno del TabControl y traerlo al panel principal o crear uno espejo
        ' Creamos un TextBox de observaciones espejo en el formulario principal (visible siempre)
        Dim txtObsPrincipal As TextBox = TryCast(Me.Controls.Find("TextBoxObsAlbPrincipal", False).FirstOrDefault(), TextBox)
        If txtObsPrincipal Is Nothing Then
            txtObsPrincipal = New TextBox() With {.Name = "TextBoxObsAlbPrincipal"}
            Me.Controls.Add(txtObsPrincipal)
            ' Sincronizar con el TextBoxObservaciones interno del TabControl
    ...
    Private Sub cboRuta_SelectionChangeCommitted(sender As Object, e As EventArgs) Handles cboRuta.SelectionChangeCommitted
        ...
        ' ¡EL TRUCO! Si habíamos elegido una agencia sin rutas, no hacemos nada y salimos.
